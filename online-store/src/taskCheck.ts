console.log(`
## Discord: Dima(@Dauhaliavets), Github: https://github.com/Dauhaliavets
# Самооценка
✔️ 1. Главная страница содержит все товары магазина а также фильтры, строку поиска, поле для сортировки. Выполняются требования к вёрстке +10
  - внешний вид приложения является улучшенной версией предложенного образца;
...
✔️ 2. Карточка товара содержит его изображение, название, количество данного товара на складе, год выпуска, производитель и т.д., находится ли товар в корзине +10  
  - Карточки товаров добавляются динамически средствами JavaScript;
✔️ 3. Добавление товаров в корзину +20
  - кликая по карточке с товаром или по кнопке на нем, товар можно добавлять в корзину или удалять. Карточки добавленных в корзину товаров внешне отличаются от остальных (меняется состояние кноки добавить/удалить) +10
  - на странице отображается количество добавленных в корзину товаров (на иконке корзины). При попытке добавить в корзину больше 20 товаров, выводится всплывающее уведомление (alert) с текстом "Извините, все слоты заполнены" +10
✔️ 4. Сортировка +20  
  ...
  - сортировка товаров по году выпуска в возрастающем и убывающем порядке +10
...
✔️ 6. Фильтры по значению +30  
  ...
  - фильтр по новизне товара +5 
  - фильтр по популярности +5
  - фильтры по категориям +5
  - фильтры по брендам +5
...
console.log('✔️ Итого: 220 баллов');
